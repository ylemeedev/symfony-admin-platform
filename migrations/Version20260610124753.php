 ...
 */
final class Version20260610124753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_ECB38BFC989D9B62 ON warehouse (slug)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_ECB38BFC989D9B62 ON warehouse');
    }
}
